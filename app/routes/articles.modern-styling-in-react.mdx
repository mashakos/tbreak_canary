...
Of course, these techniques don't require you to *only* use vanilla CSS, you can just as easily combine them with CSS-in-JS or a pre-processor. However with new features like [nesting](https://www.w3.org/TR/css-nesting-1/) and [relative colors](https://www.w3.org/TR/css-color-5/#relative-colors) I think it's becoming less necessary to reach for these tools.
