...
import reebokBackgroundLarge from '~/assets/reebok-background-large.webp';
import reebokBackgroundPlaceholder from '~/assets/reebok-background-placeholder.jpg';
import reebokBackground from '~/assets/reebok-background.webp';
...
const textureLarge = 'reebok-app-large.webp';
const texturePlaceholder = 'reebok-app-placeholder.jpg';
const texture = 'reebok-app.webp';
const texture2 = '';
const texture2Large = '';
